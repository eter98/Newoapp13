...
export class CiudadComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.ciudadService
        ...
        .subscribe(
          (res: HttpResponse<ICiudad[]>) => this.paginateCiudads(res.body, res.headers),
  ...
  registerChangeInCiudads() {
    this.eventSubscriber = this.eventManager.subscribe('ciudadListModification', response => this.reset());
  }
  ...
  protected paginateCiudads(data: ICiudad[], headers: HttpHeaders) {
