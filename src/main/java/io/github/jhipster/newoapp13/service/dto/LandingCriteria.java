...
public class LandingCriteria implements Serializable, Criteria {
    ...
    private IntegerFilter tarifaMensual;
    ...
    public LandingCriteria(LandingCriteria other){
        ...
        this.tarifaMensual = other.tarifaMensual == null ? null : other.tarifaMensual.copy();
    ...
    public IntegerFilter getTarifaMensual() {
        return tarifaMensual;
    }

    public void setTarifaMensual(IntegerFilter tarifaMensual) {
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(tarifaMensual, that.tarifaMensual) &&
    ...
    public String toString() {
        return "LandingCriteria{" +
                ...
                (tarifaMensual != null ? "tarifaMensual=" + tarifaMensual + ", " : "") +
