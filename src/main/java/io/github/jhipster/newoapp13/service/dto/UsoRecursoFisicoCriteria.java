...
public class UsoRecursoFisicoCriteria implements Serializable, Criteria {
    ...
    private ZonedDateTimeFilter registroFechaInicio;

    private ZonedDateTimeFilter registroFechaFinal;
    ...
    public ZonedDateTimeFilter getRegistroFechaInicio() {
        return registroFechaInicio;
    }

    public void setRegistroFechaInicio(ZonedDateTimeFilter registroFechaInicio) {
        this.registroFechaInicio = registroFechaInicio;
    }

    public ZonedDateTimeFilter getRegistroFechaFinal() {
        return registroFechaFinal;
    }

    public void setRegistroFechaFinal(ZonedDateTimeFilter registroFechaFinal) {
