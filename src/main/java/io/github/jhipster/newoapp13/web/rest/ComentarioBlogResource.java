...
/**
 * REST controller for managing {@link io.github.jhipster.newoapp13.domain.ComentarioBlog}.
 */
@RestController
@RequestMapping("/api")
public class ComentarioBlogResource {
    ...
    */
    ...
    public ResponseEntity<List<ComentarioBlog>> searchComentarioBlogs(@RequestParam String query, Pageable pageable) {
