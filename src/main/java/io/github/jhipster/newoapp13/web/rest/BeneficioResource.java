...
/**
 * REST controller for managing {@link io.github.jhipster.newoapp13.domain.Beneficio}.
 */
@RestController
@RequestMapping("/api")
public class BeneficioResource {
    ...
    public ResponseEntity<List<Beneficio>> getAllBeneficios(BeneficioCriteria criteria, Pageable pageable) {
    ...
    */
    ...
    public ResponseEntity<List<Beneficio>> searchBeneficios(@RequestParam String query, Pageable pageable) {
