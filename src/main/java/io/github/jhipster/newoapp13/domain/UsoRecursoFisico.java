...
public class UsoRecursoFisico implements Serializable {
    ...
    private Instant registroFechaInicio;
    ...
    public Instant getRegistroFechaInicio() {
        return registroFechaInicio;
    }

    public UsoRecursoFisico registroFechaInicio(Instant registroFechaInicio) {
        this.registroFechaInicio = registroFechaInicio;
        return this;
    }

    public void setRegistroFechaInicio(Instant registroFechaInicio) {
        this.registroFechaInicio = registroFechaInicio;
    }
