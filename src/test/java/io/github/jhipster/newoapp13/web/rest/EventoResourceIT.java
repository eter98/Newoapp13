...
public class EventoResourceIT {
    ...
    private static final Boolean DEFAULT_EVENTO_NEWO = false;
    private static final Boolean UPDATED_EVENTO_NEWO = true;
    ...
    public static Evento createEntity(EntityManager em) {
        Evento evento = new Evento()
            ...
            .eventoNEWO(DEFAULT_EVENTO_NEWO)
            .web(DEFAULT_WEB);
        return evento;
    }
    /**
    ...
    public static Evento createUpdatedEntity(EntityManager em) {
        Evento evento = new Evento()
            ...
            .eventoNEWO(UPDATED_EVENTO_NEWO)
            .web(UPDATED_WEB);
        return evento;
    }
    ...
    public void createEvento() throws Exception {
        ...
        assertThat(testEvento.isEventoNEWO()).isEqualTo(DEFAULT_EVENTO_NEWO);
        assertThat(testEvento.getWeb()).isEqualTo(DEFAULT_WEB);
    ...
    public void getAllEventos() throws Exception {
        ...
        restEventoMockMvc.perform(get("/api/eventos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].eventoNEWO").value(hasItem(DEFAULT_EVENTO_NEWO.booleanValue())))
    ...
    public void getEvento() throws Exception {
        ...
        restEventoMockMvc.perform(get("/api/eventos/{id}", evento.getId()))
            ...
            .andExpect(jsonPath("$.eventoNEWO").value(DEFAULT_EVENTO_NEWO.booleanValue()))
    ...
    @Test
    @Transactional
    public void getAllEventosByEventoNEWOIsEqualToSomething() throws Exception {
        // Initialize the database
        eventoRepository.saveAndFlush(evento);

        // Get all the eventoList where eventoNEWO equals to DEFAULT_EVENTO_NEWO
        defaultEventoShouldBeFound("eventoNEWO.equals=" + DEFAULT_EVENTO_NEWO);

        // Get all the eventoList where eventoNEWO equals to UPDATED_EVENTO_NEWO
        defaultEventoShouldNotBeFound("eventoNEWO.equals=" + UPDATED_EVENTO_NEWO);
    }

    @Test
    @Transactional
    public void getAllEventosByEventoNEWOIsInShouldWork() throws Exception {
        // Initialize the database
        eventoRepository.saveAndFlush(evento);

        // Get all the eventoList where eventoNEWO in DEFAULT_EVENTO_NEWO or UPDATED_EVENTO_NEWO
        defaultEventoShouldBeFound("eventoNEWO.in=" + DEFAULT_EVENTO_NEWO + "," + UPDATED_EVENTO_NEWO);

        // Get all the eventoList where eventoNEWO equals to UPDATED_EVENTO_NEWO
        defaultEventoShouldNotBeFound("eventoNEWO.in=" + UPDATED_EVENTO_NEWO);
    }

    @Test
    @Transactional
    public void getAllEventosByEventoNEWOIsNullOrNotNull() throws Exception {
        // Initialize the database
        eventoRepository.saveAndFlush(evento);

        // Get all the eventoList where eventoNEWO is not null
        defaultEventoShouldBeFound("eventoNEWO.specified=true");

        // Get all the eventoList where eventoNEWO is null
        defaultEventoShouldNotBeFound("eventoNEWO.specified=false");
    }

    @Test
    @Transactional
    public void getAllEventosByWebIsEqualToSomething() throws Exception {
        // Initialize the database
        eventoRepository.saveAndFlush(evento);

        // Get all the eventoList where web equals to DEFAULT_WEB
        defaultEventoShouldBeFound("web.equals=" + DEFAULT_WEB);

        // Get all the eventoList where web equals to UPDATED_WEB
        defaultEventoShouldNotBeFound("web.equals=" + UPDATED_WEB);
    }

    @Test
    @Transactional
    public void getAllEventosByWebIsInShouldWork() throws Exception {
        // Initialize the database
        eventoRepository.saveAndFlush(evento);

        // Get all the eventoList where web in DEFAULT_WEB or UPDATED_WEB
        defaultEventoShouldBeFound("web.in=" + DEFAULT_WEB + "," + UPDATED_WEB);

        // Get all the eventoList where web equals to UPDATED_WEB
        defaultEventoShouldNotBeFound("web.in=" + UPDATED_WEB);
    }

    @Test
    @Transactional
    public void getAllEventosByWebIsNullOrNotNull() throws Exception {
        // Initialize the database
        eventoRepository.saveAndFlush(evento);

        // Get all the eventoList where web is not null
        defaultEventoShouldBeFound("web.specified=true");

        // Get all the eventoList where web is null
        defaultEventoShouldNotBeFound("web.specified=false");
    }
    ...
    public void updateEvento() throws Exception {
        ...
        assertThat(testEvento.isEventoNEWO()).isEqualTo(UPDATED_EVENTO_NEWO);
        assertThat(testEvento.getWeb()).isEqualTo(UPDATED_WEB);
