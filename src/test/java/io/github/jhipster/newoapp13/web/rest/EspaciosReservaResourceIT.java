...
public class EspaciosReservaResourceIT {
    ...
    @Test
    @Transactional
    public void getAllEspaciosReservasByVideoIsEqualToSomething() throws Exception {
        // Initialize the database
        espaciosReservaRepository.saveAndFlush(espaciosReserva);

        // Get all the espaciosReservaList where video equals to DEFAULT_VIDEO
        defaultEspaciosReservaShouldBeFound("video.equals=" + DEFAULT_VIDEO);

        // Get all the espaciosReservaList where video equals to UPDATED_VIDEO
        defaultEspaciosReservaShouldNotBeFound("video.equals=" + UPDATED_VIDEO);
    }

    @Test
    @Transactional
    public void getAllEspaciosReservasByVideoIsInShouldWork() throws Exception {
        // Initialize the database
        espaciosReservaRepository.saveAndFlush(espaciosReserva);

        // Get all the espaciosReservaList where video in DEFAULT_VIDEO or UPDATED_VIDEO
        defaultEspaciosReservaShouldBeFound("video.in=" + DEFAULT_VIDEO + "," + UPDATED_VIDEO);

        // Get all the espaciosReservaList where video equals to UPDATED_VIDEO
        defaultEspaciosReservaShouldNotBeFound("video.in=" + UPDATED_VIDEO);
    }

    @Test
    @Transactional
    public void getAllEspaciosReservasByVideoIsNullOrNotNull() throws Exception {
        // Initialize the database
        espaciosReservaRepository.saveAndFlush(espaciosReserva);

        // Get all the espaciosReservaList where video is not null
        defaultEspaciosReservaShouldBeFound("video.specified=true");

        // Get all the espaciosReservaList where video is null
        defaultEspaciosReservaShouldNotBeFound("video.specified=false");
    }
