...
public class UsoRecursoFisicoResourceIT {
    ...
    private static final Instant DEFAULT_REGISTRO_FECHA_INICIO = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_REGISTRO_FECHA_INICIO = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    private static final Instant SMALLER_REGISTRO_FECHA_INICIO = Instant.ofEpochMilli(-1L);
    ...
    public void getAllUsoRecursoFisicos() throws Exception {
        ...
        restUsoRecursoFisicoMockMvc.perform(get("/api/uso-recurso-fisicos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].registroFechaInicio").value(hasItem(DEFAULT_REGISTRO_FECHA_INICIO.toString())))
    ...
    public void getUsoRecursoFisico() throws Exception {
        ...
        restUsoRecursoFisicoMockMvc.perform(get("/api/uso-recurso-fisicos/{id}", usoRecursoFisico.getId()))
            ...
            .andExpect(jsonPath("$.registroFechaInicio").value(DEFAULT_REGISTRO_FECHA_INICIO.toString()))
