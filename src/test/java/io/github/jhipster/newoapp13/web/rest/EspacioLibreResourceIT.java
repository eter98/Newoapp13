...
public class EspacioLibreResourceIT {
    ...
    @Test
    @Transactional
    public void getAllEspacioLibresByVideoIsEqualToSomething() throws Exception {
        // Initialize the database
        espacioLibreRepository.saveAndFlush(espacioLibre);

        // Get all the espacioLibreList where video equals to DEFAULT_VIDEO
        defaultEspacioLibreShouldBeFound("video.equals=" + DEFAULT_VIDEO);

        // Get all the espacioLibreList where video equals to UPDATED_VIDEO
        defaultEspacioLibreShouldNotBeFound("video.equals=" + UPDATED_VIDEO);
    }

    @Test
    @Transactional
    public void getAllEspacioLibresByVideoIsInShouldWork() throws Exception {
        // Initialize the database
        espacioLibreRepository.saveAndFlush(espacioLibre);

        // Get all the espacioLibreList where video in DEFAULT_VIDEO or UPDATED_VIDEO
        defaultEspacioLibreShouldBeFound("video.in=" + DEFAULT_VIDEO + "," + UPDATED_VIDEO);

        // Get all the espacioLibreList where video equals to UPDATED_VIDEO
        defaultEspacioLibreShouldNotBeFound("video.in=" + UPDATED_VIDEO);
    }

    @Test
    @Transactional
    public void getAllEspacioLibresByVideoIsNullOrNotNull() throws Exception {
        // Initialize the database
        espacioLibreRepository.saveAndFlush(espacioLibre);

        // Get all the espacioLibreList where video is not null
        defaultEspacioLibreShouldBeFound("video.specified=true");

        // Get all the espacioLibreList where video is null
        defaultEspacioLibreShouldNotBeFound("video.specified=false");
    }
