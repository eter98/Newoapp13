...
public class EquipoEmpresasResourceIT {
    ...
    public void createEquipoEmpresas() throws Exception {
        ...
        assertThat(testEquipoEmpresas.getLogo()).isEqualTo(DEFAULT_LOGO);
        assertThat(testEquipoEmpresas.getLogoContentType()).isEqualTo(DEFAULT_LOGO_CONTENT_TYPE);
        assertThat(testEquipoEmpresas.getPaginaWeb()).isEqualTo(DEFAULT_PAGINA_WEB);
        assertThat(testEquipoEmpresas.getConocimientosQueDomina()).isEqualTo(DEFAULT_CONOCIMIENTOS_QUE_DOMINA);
        assertThat(testEquipoEmpresas.getTemasDeInteres()).isEqualTo(DEFAULT_TEMAS_DE_INTERES);
    ...
    public void checkConocimientosQueDominaIsRequired() throws Exception {
        int databaseSizeBeforeTest = equipoEmpresasRepository.findAll().size();
        // set the field null
        equipoEmpresas.setConocimientosQueDomina(null);
    ...
    public void checkTemasDeInteresIsRequired() throws Exception {
        int databaseSizeBeforeTest = equipoEmpresasRepository.findAll().size();
        // set the field null
        equipoEmpresas.setTemasDeInteres(null);
    ...
    @Test
    @Transactional
    public void getAllEquipoEmpresasByConocimientosQueDominaIsEqualToSomething() throws Exception {
        // Initialize the database
        equipoEmpresasRepository.saveAndFlush(equipoEmpresas);

        // Get all the equipoEmpresasList where conocimientosQueDomina equals to DEFAULT_CONOCIMIENTOS_QUE_DOMINA
        defaultEquipoEmpresasShouldBeFound("conocimientosQueDomina.equals=" + DEFAULT_CONOCIMIENTOS_QUE_DOMINA);

        // Get all the equipoEmpresasList where conocimientosQueDomina equals to UPDATED_CONOCIMIENTOS_QUE_DOMINA
        defaultEquipoEmpresasShouldNotBeFound("conocimientosQueDomina.equals=" + UPDATED_CONOCIMIENTOS_QUE_DOMINA);
    }

    @Test
    @Transactional
    public void getAllEquipoEmpresasByConocimientosQueDominaIsInShouldWork() throws Exception {
        // Initialize the database
        equipoEmpresasRepository.saveAndFlush(equipoEmpresas);

        // Get all the equipoEmpresasList where conocimientosQueDomina in DEFAULT_CONOCIMIENTOS_QUE_DOMINA or UPDATED_CONOCIMIENTOS_QUE_DOMINA
        defaultEquipoEmpresasShouldBeFound("conocimientosQueDomina.in=" + DEFAULT_CONOCIMIENTOS_QUE_DOMINA + "," + UPDATED_CONOCIMIENTOS_QUE_DOMINA);

        // Get all the equipoEmpresasList where conocimientosQueDomina equals to UPDATED_CONOCIMIENTOS_QUE_DOMINA
        defaultEquipoEmpresasShouldNotBeFound("conocimientosQueDomina.in=" + UPDATED_CONOCIMIENTOS_QUE_DOMINA);
    }

    @Test
    @Transactional
    public void getAllEquipoEmpresasByConocimientosQueDominaIsNullOrNotNull() throws Exception {
        // Initialize the database
        equipoEmpresasRepository.saveAndFlush(equipoEmpresas);

        // Get all the equipoEmpresasList where conocimientosQueDomina is not null
        defaultEquipoEmpresasShouldBeFound("conocimientosQueDomina.specified=true");

        // Get all the equipoEmpresasList where conocimientosQueDomina is null
        defaultEquipoEmpresasShouldNotBeFound("conocimientosQueDomina.specified=false");
    }

    @Test
    @Transactional
    public void getAllEquipoEmpresasByTemasDeInteresIsEqualToSomething() throws Exception {
        // Initialize the database
        equipoEmpresasRepository.saveAndFlush(equipoEmpresas);

        // Get all the equipoEmpresasList where temasDeInteres equals to DEFAULT_TEMAS_DE_INTERES
        defaultEquipoEmpresasShouldBeFound("temasDeInteres.equals=" + DEFAULT_TEMAS_DE_INTERES);

        // Get all the equipoEmpresasList where temasDeInteres equals to UPDATED_TEMAS_DE_INTERES
        defaultEquipoEmpresasShouldNotBeFound("temasDeInteres.equals=" + UPDATED_TEMAS_DE_INTERES);
    }

    @Test
    @Transactional
    public void getAllEquipoEmpresasByTemasDeInteresIsInShouldWork() throws Exception {
        // Initialize the database
        equipoEmpresasRepository.saveAndFlush(equipoEmpresas);

        // Get all the equipoEmpresasList where temasDeInteres in DEFAULT_TEMAS_DE_INTERES or UPDATED_TEMAS_DE_INTERES
        defaultEquipoEmpresasShouldBeFound("temasDeInteres.in=" + DEFAULT_TEMAS_DE_INTERES + "," + UPDATED_TEMAS_DE_INTERES);

        // Get all the equipoEmpresasList where temasDeInteres equals to UPDATED_TEMAS_DE_INTERES
        defaultEquipoEmpresasShouldNotBeFound("temasDeInteres.in=" + UPDATED_TEMAS_DE_INTERES);
    }

    @Test
    @Transactional
    public void getAllEquipoEmpresasByTemasDeInteresIsNullOrNotNull() throws Exception {
        // Initialize the database
        equipoEmpresasRepository.saveAndFlush(equipoEmpresas);

        // Get all the equipoEmpresasList where temasDeInteres is not null
        defaultEquipoEmpresasShouldBeFound("temasDeInteres.specified=true");

        // Get all the equipoEmpresasList where temasDeInteres is null
        defaultEquipoEmpresasShouldNotBeFound("temasDeInteres.specified=false");
    }
    ...
    public void updateEquipoEmpresas() throws Exception {
        ...
        assertThat(testEquipoEmpresas.getLogo()).isEqualTo(UPDATED_LOGO);
        assertThat(testEquipoEmpresas.getLogoContentType()).isEqualTo(UPDATED_LOGO_CONTENT_TYPE);
        assertThat(testEquipoEmpresas.getPaginaWeb()).isEqualTo(UPDATED_PAGINA_WEB);
        assertThat(testEquipoEmpresas.getConocimientosQueDomina()).isEqualTo(UPDATED_CONOCIMIENTOS_QUE_DOMINA);
        assertThat(testEquipoEmpresas.getTemasDeInteres()).isEqualTo(UPDATED_TEMAS_DE_INTERES);
