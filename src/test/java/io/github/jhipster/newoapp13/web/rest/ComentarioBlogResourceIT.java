...
public class ComentarioBlogResourceIT {
    ...
    public void getAllComentarioBlogsByFechaIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the comentarioBlogList where fecha is greater than or equal to DEFAULT_FECHA
        defaultComentarioBlogShouldBeFound("fecha.greaterThanOrEqual=" + DEFAULT_FECHA);

        // Get all the comentarioBlogList where fecha is greater than or equal to UPDATED_FECHA
        defaultComentarioBlogShouldNotBeFound("fecha.greaterThanOrEqual=" + UPDATED_FECHA);
    }

    @Test
    @Transactional
    public void getAllComentarioBlogsByFechaIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        comentarioBlogRepository.saveAndFlush(comentarioBlog);

        // Get all the comentarioBlogList where fecha is less than or equal to DEFAULT_FECHA
        defaultComentarioBlogShouldBeFound("fecha.lessThanOrEqual=" + DEFAULT_FECHA);

        // Get all the comentarioBlogList where fecha is less than or equal to SMALLER_FECHA
        defaultComentarioBlogShouldNotBeFound("fecha.lessThanOrEqual=" + SMALLER_FECHA);
    }
    ...
    public void getAllComentarioBlogsByFechaIsLessThanSomething() throws Exception {
        ...
        // Get all the comentarioBlogList where fecha is less than DEFAULT_FECHA
        defaultComentarioBlogShouldNotBeFound("fecha.lessThan=" + DEFAULT_FECHA);

        // Get all the comentarioBlogList where fecha is less than UPDATED_FECHA
        defaultComentarioBlogShouldBeFound("fecha.lessThan=" + UPDATED_FECHA);
    }

    @Test
    @Transactional
    public void getAllComentarioBlogsByFechaIsGreaterThanSomething() throws Exception {
        // Initialize the database
        comentarioBlogRepository.saveAndFlush(comentarioBlog);

        // Get all the comentarioBlogList where fecha is greater than DEFAULT_FECHA
        defaultComentarioBlogShouldNotBeFound("fecha.greaterThan=" + DEFAULT_FECHA);

        // Get all the comentarioBlogList where fecha is greater than SMALLER_FECHA
        defaultComentarioBlogShouldBeFound("fecha.greaterThan=" + SMALLER_FECHA);
    }
