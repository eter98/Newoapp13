...
public class MiembrosResourceIT {
    ...
    public void getAllMiembrosByFechaRegistroIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the miembrosList where fechaRegistro is greater than or equal to DEFAULT_FECHA_REGISTRO
        defaultMiembrosShouldBeFound("fechaRegistro.greaterThanOrEqual=" + DEFAULT_FECHA_REGISTRO);

        // Get all the miembrosList where fechaRegistro is greater than or equal to UPDATED_FECHA_REGISTRO
        defaultMiembrosShouldNotBeFound("fechaRegistro.greaterThanOrEqual=" + UPDATED_FECHA_REGISTRO);
    }

    @Test
    @Transactional
    public void getAllMiembrosByFechaRegistroIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        miembrosRepository.saveAndFlush(miembros);

        // Get all the miembrosList where fechaRegistro is less than or equal to DEFAULT_FECHA_REGISTRO
        defaultMiembrosShouldBeFound("fechaRegistro.lessThanOrEqual=" + DEFAULT_FECHA_REGISTRO);

        // Get all the miembrosList where fechaRegistro is less than or equal to SMALLER_FECHA_REGISTRO
        defaultMiembrosShouldNotBeFound("fechaRegistro.lessThanOrEqual=" + SMALLER_FECHA_REGISTRO);
    }
    ...
    public void getAllMiembrosByFechaRegistroIsLessThanSomething() throws Exception {
        ...
        // Get all the miembrosList where fechaRegistro is less than DEFAULT_FECHA_REGISTRO
        defaultMiembrosShouldNotBeFound("fechaRegistro.lessThan=" + DEFAULT_FECHA_REGISTRO);

        // Get all the miembrosList where fechaRegistro is less than UPDATED_FECHA_REGISTRO
        defaultMiembrosShouldBeFound("fechaRegistro.lessThan=" + UPDATED_FECHA_REGISTRO);
    }

    @Test
    @Transactional
    public void getAllMiembrosByFechaRegistroIsGreaterThanSomething() throws Exception {
        // Initialize the database
        miembrosRepository.saveAndFlush(miembros);

        // Get all the miembrosList where fechaRegistro is greater than DEFAULT_FECHA_REGISTRO
        defaultMiembrosShouldNotBeFound("fechaRegistro.greaterThan=" + DEFAULT_FECHA_REGISTRO);

        // Get all the miembrosList where fechaRegistro is greater than SMALLER_FECHA_REGISTRO
        defaultMiembrosShouldBeFound("fechaRegistro.greaterThan=" + SMALLER_FECHA_REGISTRO);
    }
