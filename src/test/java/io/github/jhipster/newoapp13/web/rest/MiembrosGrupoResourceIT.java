...
public class MiembrosGrupoResourceIT {
    ...
    @Test
    @Transactional
    public void getAllMiembrosGruposByGrupoIsEqualToSomething() throws Exception {
        // Initialize the database
        miembrosGrupoRepository.saveAndFlush(miembrosGrupo);
        ...
        // Get all the miembrosGrupoList where grupo equals to grupoId
        defaultMiembrosGrupoShouldBeFound("grupoId.equals=" + grupoId);

        // Get all the miembrosGrupoList where grupo equals to grupoId + 1
        defaultMiembrosGrupoShouldNotBeFound("grupoId.equals=" + (grupoId + 1));
    }
