...
public class BlogResourceIT {
    ...
    public void getAllBlogsByFechaIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the blogList where fecha is greater than or equal to DEFAULT_FECHA
        defaultBlogShouldBeFound("fecha.greaterThanOrEqual=" + DEFAULT_FECHA);

        // Get all the blogList where fecha is greater than or equal to UPDATED_FECHA
        defaultBlogShouldNotBeFound("fecha.greaterThanOrEqual=" + UPDATED_FECHA);
    }

    @Test
    @Transactional
    public void getAllBlogsByFechaIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        blogRepository.saveAndFlush(blog);

        // Get all the blogList where fecha is less than or equal to DEFAULT_FECHA
        defaultBlogShouldBeFound("fecha.lessThanOrEqual=" + DEFAULT_FECHA);

        // Get all the blogList where fecha is less than or equal to SMALLER_FECHA
        defaultBlogShouldNotBeFound("fecha.lessThanOrEqual=" + SMALLER_FECHA);
    }
    ...
    public void getAllBlogsByFechaIsLessThanSomething() throws Exception {
        ...
        // Get all the blogList where fecha is less than DEFAULT_FECHA
        defaultBlogShouldNotBeFound("fecha.lessThan=" + DEFAULT_FECHA);

        // Get all the blogList where fecha is less than UPDATED_FECHA
        defaultBlogShouldBeFound("fecha.lessThan=" + UPDATED_FECHA);
    }

    @Test
    @Transactional
    public void getAllBlogsByFechaIsGreaterThanSomething() throws Exception {
        // Initialize the database
        blogRepository.saveAndFlush(blog);

        // Get all the blogList where fecha is greater than DEFAULT_FECHA
        defaultBlogShouldNotBeFound("fecha.greaterThan=" + DEFAULT_FECHA);

        // Get all the blogList where fecha is greater than SMALLER_FECHA
        defaultBlogShouldBeFound("fecha.greaterThan=" + SMALLER_FECHA);
    }
