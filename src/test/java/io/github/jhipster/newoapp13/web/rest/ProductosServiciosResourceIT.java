...
public class ProductosServiciosResourceIT {
    ...
    public void createProductosServicios() throws Exception {
        ...
        assertThat(testProductosServicios.getWeb()).isEqualTo(DEFAULT_WEB);
    ...
    @Test
    @Transactional
    public void getAllProductosServiciosByVideoIsEqualToSomething() throws Exception {
        // Initialize the database
        productosServiciosRepository.saveAndFlush(productosServicios);

        // Get all the productosServiciosList where video equals to DEFAULT_VIDEO
        defaultProductosServiciosShouldBeFound("video.equals=" + DEFAULT_VIDEO);

        // Get all the productosServiciosList where video equals to UPDATED_VIDEO
        defaultProductosServiciosShouldNotBeFound("video.equals=" + UPDATED_VIDEO);
    }

    @Test
    @Transactional
    public void getAllProductosServiciosByVideoIsInShouldWork() throws Exception {
        // Initialize the database
        productosServiciosRepository.saveAndFlush(productosServicios);

        // Get all the productosServiciosList where video in DEFAULT_VIDEO or UPDATED_VIDEO
        defaultProductosServiciosShouldBeFound("video.in=" + DEFAULT_VIDEO + "," + UPDATED_VIDEO);

        // Get all the productosServiciosList where video equals to UPDATED_VIDEO
        defaultProductosServiciosShouldNotBeFound("video.in=" + UPDATED_VIDEO);
    }

    @Test
    @Transactional
    public void getAllProductosServiciosByVideoIsNullOrNotNull() throws Exception {
        // Initialize the database
        productosServiciosRepository.saveAndFlush(productosServicios);

        // Get all the productosServiciosList where video is not null
        defaultProductosServiciosShouldBeFound("video.specified=true");

        // Get all the productosServiciosList where video is null
        defaultProductosServiciosShouldNotBeFound("video.specified=false");
    }

    @Test
    @Transactional
    public void getAllProductosServiciosByWebIsEqualToSomething() throws Exception {
        // Initialize the database
        productosServiciosRepository.saveAndFlush(productosServicios);

        // Get all the productosServiciosList where web equals to DEFAULT_WEB
        defaultProductosServiciosShouldBeFound("web.equals=" + DEFAULT_WEB);

        // Get all the productosServiciosList where web equals to UPDATED_WEB
        defaultProductosServiciosShouldNotBeFound("web.equals=" + UPDATED_WEB);
    }

    @Test
    @Transactional
    public void getAllProductosServiciosByWebIsInShouldWork() throws Exception {
        // Initialize the database
        productosServiciosRepository.saveAndFlush(productosServicios);

        // Get all the productosServiciosList where web in DEFAULT_WEB or UPDATED_WEB
        defaultProductosServiciosShouldBeFound("web.in=" + DEFAULT_WEB + "," + UPDATED_WEB);

        // Get all the productosServiciosList where web equals to UPDATED_WEB
        defaultProductosServiciosShouldNotBeFound("web.in=" + UPDATED_WEB);
    }

    @Test
    @Transactional
    public void getAllProductosServiciosByWebIsNullOrNotNull() throws Exception {
        // Initialize the database
        productosServiciosRepository.saveAndFlush(productosServicios);

        // Get all the productosServiciosList where web is not null
        defaultProductosServiciosShouldBeFound("web.specified=true");

        // Get all the productosServiciosList where web is null
        defaultProductosServiciosShouldNotBeFound("web.specified=false");
    }

    @Test
    @Transactional
    public void getAllProductosServiciosByMiembroIsEqualToSomething() throws Exception {
        // Initialize the database
        productosServiciosRepository.saveAndFlush(productosServicios);
        Miembros miembro = MiembrosResourceIT.createEntity(em);
        em.persist(miembro);
        em.flush();
        productosServicios.setMiembro(miembro);
        productosServiciosRepository.saveAndFlush(productosServicios);
        Long miembroId = miembro.getId();

        // Get all the productosServiciosList where miembro equals to miembroId
        defaultProductosServiciosShouldBeFound("miembroId.equals=" + miembroId);

        // Get all the productosServiciosList where miembro equals to miembroId + 1
        defaultProductosServiciosShouldNotBeFound("miembroId.equals=" + (miembroId + 1));
    }
    ...
    public void updateProductosServicios() throws Exception {
        ...
        assertThat(testProductosServicios.getWeb()).isEqualTo(UPDATED_WEB);
